...
func (e RetrigVolumeSlide) Start(cs *channel.State, p playback.Playback) error {
	cs.ResetRetriggerCount()
	return nil
}

// Tick is called on every tick
func (e RetrigVolumeSlide) Tick(cs *channel.State, p playback.Playback, currentTick int) error {
