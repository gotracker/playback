...
func (e FineVibrato) Start(cs playback.Channel[channel.Memory], p playback.Playback) error {
...
func (e FineVibrato) Tick(cs playback.Channel[channel.Memory], p playback.Playback, currentTick int) error {
	mem := cs.GetMemory()
