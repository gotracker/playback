...
func (e ChannelVolumeSlide) Start(cs *channel.State, p playback.Playback) error {
...
func (e ChannelVolumeSlide) Tick(cs *channel.State, p playback.Playback, currentTick int) error {
	mem := cs.GetMemory()
	x, y := mem.ChannelVolumeSlide(channel.DataEffect(e))
