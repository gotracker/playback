...
func (v *itVoice[TPeriod]) Render(centerAheadPan volume.Matrix, details render.Details, renderChannel *render.Channel[itVolume.FineVolume, itVolume.FineVolume, itPanning.Panning]) (*mixing.Data, error) {
	if v.IsDone() {
		return nil, nil
	}
