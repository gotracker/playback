...
func (e NoteDelay[TPeriod]) PreStart(cs playback.Channel[TPeriod, Memory], p playback.Playback) error {
	cs.SetNotePlayTick(true, note.ActionRetrigger, int(DataEffect(e)&0x0F))
	return nil
}

// Start triggers on the first tick, but before the Tick() function is called
func (e NoteDelay[TPeriod]) Start(cs playback.Channel[TPeriod, Memory], p playback.Playback) error {
