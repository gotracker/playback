...
func extraFinePortaEffectFactory[TPeriod period.Period](mem *Memory, ce Command, cp DataEffect) EffectXM {
	switch cp >> 4 {
	case 0x0: // none
		return nil
...
func specialEffectFactory[TPeriod period.Period](mem *Memory, ce Command, cp DataEffect) EffectXM {
	switch cp >> 4 {
