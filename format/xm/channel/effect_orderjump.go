...
func (e OrderJump[TPeriod]) Start(cs playback.Channel[TPeriod, Memory], p playback.Playback) error {
	cs.ResetRetriggerCount()
	return nil
}

// Stop is called on the last tick of the row, but after the Tick() function is called
func (e OrderJump[TPeriod]) Stop(cs playback.Channel[TPeriod, Memory], p playback.Playback, lastTick int) error {
