...
func (v *xmVoice[TPeriod]) SetActive(on bool) {
	v.amp.SetActive(on)
}
...
func (v *xmVoice[TPeriod]) SetMixingVolume(vol xmVolume.XmVolume) {
...
func (v *xmVoice[TPeriod]) SetVolumeDelta(d types.VolumeDelta) {
