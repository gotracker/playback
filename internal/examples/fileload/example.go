...
// ExamplePlayFileToStdout will read in a music module file (in this case: `test/ode_to_protracker.mod`)
...
func ExamplePlayFileToStdout() {
	const (
		filename     = "./test/ode_to_protracker.mod"
		sampleRate   = 44100
		channels     = 2
